    ...
    implements MigrationInterface
{
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "care_questions" ADD "id" SERIAL NOT NULL`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" DROP CONSTRAINT "PK_9588b20fef21cab48eb130aa82b"`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" ADD CONSTRAINT "PK_4cf3e3677d5ce888ccf8a7ad0b6" PRIMARY KEY ("description", "id")`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" DROP CONSTRAINT "PK_4cf3e3677d5ce888ccf8a7ad0b6"`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" ADD CONSTRAINT "PK_07e7e34ad7de2757a8583b4e541" PRIMARY KEY ("id")`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "care_questions" DROP CONSTRAINT "PK_07e7e34ad7de2757a8583b4e541"`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" ADD CONSTRAINT "PK_4cf3e3677d5ce888ccf8a7ad0b6" PRIMARY KEY ("description", "id")`,
        );
        ...
        await queryRunner.query(
            `ALTER TABLE "care_questions" ADD CONSTRAINT "PK_9588b20fef21cab48eb130aa82b" PRIMARY KEY ("description")`,
        );
        await queryRunner.query(
            `ALTER TABLE "care_questions" DROP COLUMN "id"`,
        );
